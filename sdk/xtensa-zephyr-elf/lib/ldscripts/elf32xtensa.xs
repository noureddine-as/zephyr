...
ENTRY(_start)
SEARCH_DIR("=/home/buildslave/src/github.com/zephyrproject-rtos/sdk-ng/build/output/xtensa-zephyr-elf/xtensa-zephyr-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
