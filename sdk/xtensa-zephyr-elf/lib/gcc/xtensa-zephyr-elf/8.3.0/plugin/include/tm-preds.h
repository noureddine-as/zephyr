/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/buildslave/src/github.com/zephyrproject-rtos/sdk-ng/build/build_xtensa/.build/xtensa-zephyr-elf/src/gcc/gcc/config/xtensa/xtensa.md'.  */
