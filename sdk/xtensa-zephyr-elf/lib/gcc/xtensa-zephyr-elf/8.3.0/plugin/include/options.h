...
enum opt_code
{
  ...
  OPT_mauto_litpools = 1190,                 /* -mauto-litpools */
  OPT_mconst16 = 1191,                       /* -mconst16 */
  OPT_mforce_no_pic = 1192,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1193, */              /* -mfused-madd */
  OPT_mlongcalls = 1194,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1195,            /* -mserialize-volatile */
  OPT_mtarget_align = 1196,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1197,         /* -mtext-section-literals */
  OPT_n = 1198,                              /* -n */
  ...
  OPT_static_libmpx = 1244,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1245,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1246,               /* -static-libstdc++ */
  OPT_static_libtsan = 1247,                 /* -static-libtsan */
  OPT_static_libubsan = 1248,                /* -static-libubsan */
  OPT_static_pie = 1249,                     /* -static-pie */
  /* OPT_std_c__03 = 1250, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1251, */                /* -std=c++0x */
  OPT_std_c__11 = 1252,                      /* -std=c++11 */
  OPT_std_c__14 = 1253,                      /* -std=c++14 */
  OPT_std_c__17 = 1254,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1255, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1256, */                /* -std=c++1z */
  OPT_std_c__2a = 1257,                      /* -std=c++2a */
  OPT_std_c__98 = 1258,                      /* -std=c++98 */
  OPT_std_c11 = 1259,                        /* -std=c11 */
  OPT_std_c17 = 1260,                        /* -std=c17 */
  /* OPT_std_c18 = 1261, */                  /* -std=c18 */
  ...
  OPT_std_gnu__2a = 1280,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1281,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1282,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1283,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1284, */                /* -std=gnu18 */
  ...
  /* OPT_std_iso9899_2017 = 1295, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1296, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1297,                     /* -std=legacy */
  OPT_symbolic = 1298,                       /* -symbolic */
  OPT_t = 1299,                              /* -t */
  OPT_time = 1300,                           /* -time */
  OPT_time_ = 1301,                          /* -time= */
