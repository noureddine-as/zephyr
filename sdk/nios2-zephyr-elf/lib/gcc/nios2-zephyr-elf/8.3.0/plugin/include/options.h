...
enum opt_code
{
  ...
  OPT_mbmx = 1192,                           /* -mbmx */
  OPT_mbypass_cache = 1193,                  /* -mbypass-cache */
  OPT_mcache_volatile = 1194,                /* -mcache-volatile */
  OPT_mcdx = 1195,                           /* -mcdx */
  OPT_mcustom_fabsd_ = 1196,                 /* -mcustom-fabsd= */
  OPT_mcustom_fabss_ = 1197,                 /* -mcustom-fabss= */
  OPT_mcustom_faddd_ = 1198,                 /* -mcustom-faddd= */
  OPT_mcustom_fadds_ = 1199,                 /* -mcustom-fadds= */
  OPT_mcustom_fatand_ = 1200,                /* -mcustom-fatand= */
  OPT_mcustom_fatans_ = 1201,                /* -mcustom-fatans= */
  OPT_mcustom_fcmpeqd_ = 1202,               /* -mcustom-fcmpeqd= */
  OPT_mcustom_fcmpeqs_ = 1203,               /* -mcustom-fcmpeqs= */
  OPT_mcustom_fcmpged_ = 1204,               /* -mcustom-fcmpged= */
  OPT_mcustom_fcmpges_ = 1205,               /* -mcustom-fcmpges= */
  OPT_mcustom_fcmpgtd_ = 1206,               /* -mcustom-fcmpgtd= */
  OPT_mcustom_fcmpgts_ = 1207,               /* -mcustom-fcmpgts= */
  OPT_mcustom_fcmpled_ = 1208,               /* -mcustom-fcmpled= */
  OPT_mcustom_fcmples_ = 1209,               /* -mcustom-fcmples= */
  OPT_mcustom_fcmpltd_ = 1210,               /* -mcustom-fcmpltd= */
  OPT_mcustom_fcmplts_ = 1211,               /* -mcustom-fcmplts= */
  OPT_mcustom_fcmpned_ = 1212,               /* -mcustom-fcmpned= */
  OPT_mcustom_fcmpnes_ = 1213,               /* -mcustom-fcmpnes= */
  OPT_mcustom_fcosd_ = 1214,                 /* -mcustom-fcosd= */
  OPT_mcustom_fcoss_ = 1215,                 /* -mcustom-fcoss= */
  OPT_mcustom_fdivd_ = 1216,                 /* -mcustom-fdivd= */
  OPT_mcustom_fdivs_ = 1217,                 /* -mcustom-fdivs= */
  OPT_mcustom_fexpd_ = 1218,                 /* -mcustom-fexpd= */
  OPT_mcustom_fexps_ = 1219,                 /* -mcustom-fexps= */
  OPT_mcustom_fextsd_ = 1220,                /* -mcustom-fextsd= */
  OPT_mcustom_fixdi_ = 1221,                 /* -mcustom-fixdi= */
  OPT_mcustom_fixdu_ = 1222,                 /* -mcustom-fixdu= */
  OPT_mcustom_fixsi_ = 1223,                 /* -mcustom-fixsi= */
  OPT_mcustom_fixsu_ = 1224,                 /* -mcustom-fixsu= */
  OPT_mcustom_floatid_ = 1225,               /* -mcustom-floatid= */
  OPT_mcustom_floatis_ = 1226,               /* -mcustom-floatis= */
  OPT_mcustom_floatud_ = 1227,               /* -mcustom-floatud= */
  OPT_mcustom_floatus_ = 1228,               /* -mcustom-floatus= */
  OPT_mcustom_flogd_ = 1229,                 /* -mcustom-flogd= */
  OPT_mcustom_flogs_ = 1230,                 /* -mcustom-flogs= */
  OPT_mcustom_fmaxd_ = 1231,                 /* -mcustom-fmaxd= */
  OPT_mcustom_fmaxs_ = 1232,                 /* -mcustom-fmaxs= */
  OPT_mcustom_fmind_ = 1233,                 /* -mcustom-fmind= */
  OPT_mcustom_fmins_ = 1234,                 /* -mcustom-fmins= */
  OPT_mcustom_fmuld_ = 1235,                 /* -mcustom-fmuld= */
  OPT_mcustom_fmuls_ = 1236,                 /* -mcustom-fmuls= */
  OPT_mcustom_fnegd_ = 1237,                 /* -mcustom-fnegd= */
  OPT_mcustom_fnegs_ = 1238,                 /* -mcustom-fnegs= */
  OPT_mcustom_fpu_cfg_ = 1239,               /* -mcustom-fpu-cfg= */
  OPT_mcustom_frdxhi_ = 1240,                /* -mcustom-frdxhi= */
  OPT_mcustom_frdxlo_ = 1241,                /* -mcustom-frdxlo= */
  OPT_mcustom_frdy_ = 1242,                  /* -mcustom-frdy= */
  OPT_mcustom_fsind_ = 1243,                 /* -mcustom-fsind= */
  OPT_mcustom_fsins_ = 1244,                 /* -mcustom-fsins= */
  OPT_mcustom_fsqrtd_ = 1245,                /* -mcustom-fsqrtd= */
  OPT_mcustom_fsqrts_ = 1246,                /* -mcustom-fsqrts= */
  OPT_mcustom_fsubd_ = 1247,                 /* -mcustom-fsubd= */
  OPT_mcustom_fsubs_ = 1248,                 /* -mcustom-fsubs= */
  OPT_mcustom_ftand_ = 1249,                 /* -mcustom-ftand= */
  OPT_mcustom_ftans_ = 1250,                 /* -mcustom-ftans= */
  OPT_mcustom_ftruncds_ = 1251,              /* -mcustom-ftruncds= */
  OPT_mcustom_fwrx_ = 1252,                  /* -mcustom-fwrx= */
  OPT_mcustom_fwry_ = 1253,                  /* -mcustom-fwry= */
  OPT_mcustom_round_ = 1254,                 /* -mcustom-round= */
  OPT_meb = 1255,                            /* -meb */
  OPT_mel = 1256,                            /* -mel */
  OPT_mfast_sw_div = 1257,                   /* -mfast-sw-div */
  OPT_mgpopt = 1258,                         /* -mgpopt */
  OPT_mgpopt_ = 1259,                        /* -mgpopt= */
  OPT_mgprel_sec_ = 1260,                    /* -mgprel-sec= */
  OPT_mhal = 1261,                           /* -mhal */
  OPT_mhw_div = 1262,                        /* -mhw-div */
  OPT_mhw_mul = 1263,                        /* -mhw-mul */
  OPT_mhw_mulx = 1264,                       /* -mhw-mulx */
  OPT_mno_cache_volatile = 1265,             /* -mno-cache-volatile */
  OPT_mno_custom_fabsd = 1266,               /* -mno-custom-fabsd */
  OPT_mno_custom_fabss = 1267,               /* -mno-custom-fabss */
  OPT_mno_custom_faddd = 1268,               /* -mno-custom-faddd */
  OPT_mno_custom_fadds = 1269,               /* -mno-custom-fadds */
  OPT_mno_custom_fatand = 1270,              /* -mno-custom-fatand */
  OPT_mno_custom_fatans = 1271,              /* -mno-custom-fatans */
  OPT_mno_custom_fcmpeqd = 1272,             /* -mno-custom-fcmpeqd */
  OPT_mno_custom_fcmpeqs = 1273,             /* -mno-custom-fcmpeqs */
  OPT_mno_custom_fcmpged = 1274,             /* -mno-custom-fcmpged */
  OPT_mno_custom_fcmpges = 1275,             /* -mno-custom-fcmpges */
  OPT_mno_custom_fcmpgtd = 1276,             /* -mno-custom-fcmpgtd */
  OPT_mno_custom_fcmpgts = 1277,             /* -mno-custom-fcmpgts */
  OPT_mno_custom_fcmpled = 1278,             /* -mno-custom-fcmpled */
  OPT_mno_custom_fcmples = 1279,             /* -mno-custom-fcmples */
  OPT_mno_custom_fcmpltd = 1280,             /* -mno-custom-fcmpltd */
  OPT_mno_custom_fcmplts = 1281,             /* -mno-custom-fcmplts */
  OPT_mno_custom_fcmpned = 1282,             /* -mno-custom-fcmpned */
  OPT_mno_custom_fcmpnes = 1283,             /* -mno-custom-fcmpnes */
  OPT_mno_custom_fcosd = 1284,               /* -mno-custom-fcosd */
  OPT_mno_custom_fcoss = 1285,               /* -mno-custom-fcoss */
  OPT_mno_custom_fdivd = 1286,               /* -mno-custom-fdivd */
  OPT_mno_custom_fdivs = 1287,               /* -mno-custom-fdivs */
  OPT_mno_custom_fexpd = 1288,               /* -mno-custom-fexpd */
  OPT_mno_custom_fexps = 1289,               /* -mno-custom-fexps */
  OPT_mno_custom_fextsd = 1290,              /* -mno-custom-fextsd */
  OPT_mno_custom_fixdi = 1291,               /* -mno-custom-fixdi */
  OPT_mno_custom_fixdu = 1292,               /* -mno-custom-fixdu */
  OPT_mno_custom_fixsi = 1293,               /* -mno-custom-fixsi */
  OPT_mno_custom_fixsu = 1294,               /* -mno-custom-fixsu */
  OPT_mno_custom_floatid = 1295,             /* -mno-custom-floatid */
  OPT_mno_custom_floatis = 1296,             /* -mno-custom-floatis */
  OPT_mno_custom_floatud = 1297,             /* -mno-custom-floatud */
  OPT_mno_custom_floatus = 1298,             /* -mno-custom-floatus */
  OPT_mno_custom_flogd = 1299,               /* -mno-custom-flogd */
  OPT_mno_custom_flogs = 1300,               /* -mno-custom-flogs */
  OPT_mno_custom_fmaxd = 1301,               /* -mno-custom-fmaxd */
  OPT_mno_custom_fmaxs = 1302,               /* -mno-custom-fmaxs */
  OPT_mno_custom_fmind = 1303,               /* -mno-custom-fmind */
  OPT_mno_custom_fmins = 1304,               /* -mno-custom-fmins */
  OPT_mno_custom_fmuld = 1305,               /* -mno-custom-fmuld */
  OPT_mno_custom_fmuls = 1306,               /* -mno-custom-fmuls */
  OPT_mno_custom_fnegd = 1307,               /* -mno-custom-fnegd */
  OPT_mno_custom_fnegs = 1308,               /* -mno-custom-fnegs */
  OPT_mno_custom_frdxhi = 1309,              /* -mno-custom-frdxhi */
  OPT_mno_custom_frdxlo = 1310,              /* -mno-custom-frdxlo */
  OPT_mno_custom_frdy = 1311,                /* -mno-custom-frdy */
  OPT_mno_custom_fsind = 1312,               /* -mno-custom-fsind */
  OPT_mno_custom_fsins = 1313,               /* -mno-custom-fsins */
  OPT_mno_custom_fsqrtd = 1314,              /* -mno-custom-fsqrtd */
  OPT_mno_custom_fsqrts = 1315,              /* -mno-custom-fsqrts */
  OPT_mno_custom_fsubd = 1316,               /* -mno-custom-fsubd */
  OPT_mno_custom_fsubs = 1317,               /* -mno-custom-fsubs */
  OPT_mno_custom_ftand = 1318,               /* -mno-custom-ftand */
  OPT_mno_custom_ftans = 1319,               /* -mno-custom-ftans */
  OPT_mno_custom_ftruncds = 1320,            /* -mno-custom-ftruncds */
  OPT_mno_custom_fwrx = 1321,                /* -mno-custom-fwrx */
  OPT_mno_custom_fwry = 1322,                /* -mno-custom-fwry */
  OPT_mno_custom_round = 1323,               /* -mno-custom-round */
  OPT_mno_gpopt = 1324,                      /* -mno-gpopt */
  OPT_mr0rel_sec_ = 1325,                    /* -mr0rel-sec= */
  OPT_msmallc = 1326,                        /* -msmallc */
  OPT_msys_crt0_ = 1327,                     /* -msys-crt0= */
  OPT_msys_lib_ = 1328,                      /* -msys-lib= */
  OPT_n = 1329,                              /* -n */
  ...
  OPT_nostartfiles = 1335,                   /* -nostartfiles */
  OPT_nostdinc = 1336,                       /* -nostdinc */
  OPT_nostdinc__ = 1337,                     /* -nostdinc++ */
  OPT_nostdlib = 1338,                       /* -nostdlib */
  OPT_o = 1339,                              /* -o */
  OPT_p = 1340,                              /* -p */
  ...
  OPT_static_libgfortran = 1371,             /* -static-libgfortran */
  OPT_static_libgo = 1372,                   /* -static-libgo */
  OPT_static_liblsan = 1373,                 /* -static-liblsan */
  OPT_static_libmpx = 1374,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1375,          /* -static-libmpxwrappers */
