/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/buildslave/src/github.com/zephyrproject-rtos/sdk-ng/build/build_riscv64/.build/riscv64-zephyr-elf/src/gcc/gcc/config/riscv/riscv.md'.  */
