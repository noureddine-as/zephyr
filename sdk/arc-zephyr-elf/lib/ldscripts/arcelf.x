...
OUTPUT_ARCH(arc)
ENTRY(__start)
SEARCH_DIR("=/home/buildslave/src/github.com/zephyrproject-rtos/sdk-ng/build/output/arc-zephyr-elf/arc-zephyr-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
