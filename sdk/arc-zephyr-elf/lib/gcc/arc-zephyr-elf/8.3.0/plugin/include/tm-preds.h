/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/buildslave/src/github.com/zephyrproject-rtos/sdk-ng/build/build_arc/.build/arc-zephyr-elf/src/gcc/gcc/config/arc/arc.md'.  */
