...
#define MASK_NO_MILLICODE_THUNK_SET (1U << 19)
#define MASK_NOMPY_SET (1U << 20)
#define MASK_VOLATILE_CACHE_SET (1U << 21)
#define MASK_NORM_SET (1U << 22)
#define MASK_RF16 (1U << 23)
#define MASK_NO_SDATA_SET (1U << 24)
#define MASK_SIMD_SET (1U << 25)
#define MASK_0 (1U << 26)
#define MASK_SPFP_COMPACT_SET (1U << 27)
#define MASK_SPFP_FAST_SET (1U << 28)
#define MASK_SWAP_SET (1U << 29)
...
enum opt_code
{
  ...
  OPT_mA6 = 1193,                            /* -mA6 */
  OPT_mA7 = 1194,                            /* -mA7 */
  OPT_mARC600 = 1195,                        /* -mARC600 */
  OPT_mARC601 = 1196,                        /* -mARC601 */
  OPT_mARC700 = 1197,                        /* -mARC700 */
  OPT_mEA = 1198,                            /* -mEA */
  OPT_mRcq = 1199,                           /* -mRcq */
  OPT_mRcw = 1200,                           /* -mRcw */
  OPT_malign_call = 1201,                    /* -malign-call */
  OPT_mannotate_align = 1202,                /* -mannotate-align */
  OPT_marclinux = 1203,                      /* -marclinux */
  OPT_marclinux_prof = 1204,                 /* -marclinux_prof */
  OPT_margonaut = 1205,                      /* -margonaut */
  OPT_matomic = 1206,                        /* -matomic */
  OPT_mauto_modify_reg = 1207,               /* -mauto-modify-reg */
  OPT_mbarrel_shifter = 1208,                /* -mbarrel-shifter */
  OPT_mbbit_peephole = 1209,                 /* -mbbit-peephole */
  OPT_mbig_endian = 1210,                    /* -mbig-endian */
  OPT_mbitops = 1211,                        /* -mbitops */
  OPT_mcase_vector_pcrel = 1212,             /* -mcase-vector-pcrel */
  OPT_mcmem = 1213,                          /* -mcmem */
  OPT_mcode_density = 1214,                  /* -mcode-density */
  OPT_mcompact_casesi = 1215,                /* -mcompact-casesi */
  OPT_mcpu_ = 1216,                          /* -mcpu= */
  OPT_mcrc = 1217,                           /* -mcrc */
  OPT_mdiv_rem = 1218,                       /* -mdiv-rem */
  OPT_mdpfp = 1219,                          /* -mdpfp */
  OPT_mdpfp_compact = 1220,                  /* -mdpfp-compact */
  OPT_mdpfp_fast = 1221,                     /* -mdpfp-fast */
  OPT_mdsp_packa = 1222,                     /* -mdsp-packa */
  OPT_mdvbf = 1223,                          /* -mdvbf */
  OPT_mea = 1224,                            /* -mea */
  OPT_mearly_cbranchsi = 1225,               /* -mearly-cbranchsi */
  OPT_mexpand_adddi = 1226,                  /* -mexpand-adddi */
  OPT_mfpu_ = 1227,                          /* -mfpu= */
  OPT_mindexed_loads = 1228,                 /* -mindexed-loads */
  OPT_mirq_ctrl_saved_ = 1229,               /* -mirq-ctrl-saved= */
  OPT_misize = 1230,                         /* -misize */
  OPT_mjli_always = 1231,                    /* -mjli-always */
  OPT_mlittle_endian = 1232,                 /* -mlittle-endian */
  OPT_mll64 = 1233,                          /* -mll64 */
  OPT_mlock = 1234,                          /* -mlock */
  OPT_mlong_calls = 1235,                    /* -mlong-calls */
  OPT_mlpc_width_ = 1236,                    /* -mlpc-width= */
  OPT_mlra = 1237,                           /* -mlra */
  OPT_mlra_priority_compact = 1238,          /* -mlra-priority-compact */
  OPT_mlra_priority_noncompact = 1239,       /* -mlra-priority-noncompact */
  OPT_mlra_priority_none = 1240,             /* -mlra-priority-none */
  OPT_mmac_24 = 1241,                        /* -mmac-24 */
  OPT_mmac_d16 = 1242,                       /* -mmac-d16 */
  OPT_mmedium_calls = 1243,                  /* -mmedium-calls */
  OPT_mmixed_code = 1244,                    /* -mmixed-code */
  OPT_mmpy_option_ = 1245,                   /* -mmpy-option= */
  OPT_mmul32x16 = 1246,                      /* -mmul32x16 */
  OPT_mmul64 = 1247,                         /* -mmul64 */
  OPT_mmultcost_ = 1248,                     /* -mmultcost= */
  OPT_mno_brcc = 1249,                       /* -mno-brcc */
  OPT_mno_cond_exec = 1250,                  /* -mno-cond-exec */
  OPT_mno_dpfp_lrsr = 1251,                  /* -mno-dpfp-lrsr */
  OPT_mno_millicode = 1252,                  /* -mno-millicode */
  OPT_mno_mpy = 1253,                        /* -mno-mpy */
  OPT_mno_volatile_cache = 1254,             /* -mno-volatile-cache */
  OPT_mnorm = 1255,                          /* -mnorm */
  OPT_mq_class = 1256,                       /* -mq-class */
  OPT_mrf16 = 1257,                          /* -mrf16 */
  OPT_mrgf_banked_regs_ = 1258,              /* -mrgf-banked-regs= */
  OPT_mrtsc = 1259,                          /* -mrtsc */
  OPT_msdata = 1260,                         /* -msdata */
  OPT_msimd = 1261,                          /* -msimd */
  OPT_msize_level_ = 1262,                   /* -msize-level= */
  OPT_msoft_float = 1263,                    /* -msoft-float */
  OPT_mspfp = 1264,                          /* -mspfp */
  OPT_mspfp_compact = 1265,                  /* -mspfp-compact */
  OPT_mspfp_fast = 1266,                     /* -mspfp-fast */
  OPT_mswap = 1267,                          /* -mswap */
  OPT_mswape = 1268,                         /* -mswape */
  OPT_mtelephony = 1269,                     /* -mtelephony */
  OPT_mtp_regno_ = 1270,                     /* -mtp-regno= */
  OPT_mtp_regno_none = 1271,                 /* -mtp-regno=none */
  OPT_mtune_ = 1272,                         /* -mtune= */
  OPT_multcost_ = 1273,                      /* -multcost= */
  OPT_munalign_prob_threshold_ = 1274,       /* -munalign-prob-threshold= */
  OPT_munaligned_access = 1275,              /* -munaligned-access */
  OPT_mvolatile_cache = 1276,                /* -mvolatile-cache */
  OPT_mxy = 1277,                            /* -mxy */
  OPT_n = 1278,                              /* -n */
  ...
  OPT_s = 1310,                              /* -s */
  OPT_save_temps = 1311,                     /* -save-temps */
  OPT_save_temps_ = 1312,                    /* -save-temps= */
  OPT_shared = 1313,                         /* -shared */
  OPT_shared_libgcc = 1314,                  /* -shared-libgcc */
  /* OPT_specs = 1315, */                    /* -specs */
  OPT_specs_ = 1316,                         /* -specs= */
  OPT_static = 1317,                         /* -static */
  OPT_static_libasan = 1318,                 /* -static-libasan */
  OPT_static_libgcc = 1319,                  /* -static-libgcc */
  OPT_static_libgfortran = 1320,             /* -static-libgfortran */
  OPT_static_libgo = 1321,                   /* -static-libgo */
  OPT_static_liblsan = 1322,                 /* -static-liblsan */
  OPT_static_libmpx = 1323,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1324,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1325,               /* -static-libstdc++ */
  OPT_static_libtsan = 1326,                 /* -static-libtsan */
  OPT_static_libubsan = 1327,                /* -static-libubsan */
  OPT_static_pie = 1328,                     /* -static-pie */
  /* OPT_std_c__03 = 1329, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1330, */                /* -std=c++0x */
  OPT_std_c__11 = 1331,                      /* -std=c++11 */
  OPT_std_c__14 = 1332,                      /* -std=c++14 */
  OPT_std_c__17 = 1333,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1334, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1335, */                /* -std=c++1z */
  OPT_std_c__2a = 1336,                      /* -std=c++2a */
  OPT_std_c__98 = 1337,                      /* -std=c++98 */
  OPT_std_c11 = 1338,                        /* -std=c11 */
  OPT_std_c17 = 1339,                        /* -std=c17 */
  /* OPT_std_c18 = 1340, */                  /* -std=c18 */
  /* OPT_std_c1x = 1341, */                  /* -std=c1x */
  /* OPT_std_c89 = 1342, */                  /* -std=c89 */
  OPT_std_c90 = 1343,                        /* -std=c90 */
  OPT_std_c99 = 1344,                        /* -std=c99 */
  /* OPT_std_c9x = 1345, */                  /* -std=c9x */
  OPT_std_f2003 = 1346,                      /* -std=f2003 */
  OPT_std_f2008 = 1347,                      /* -std=f2008 */
  OPT_std_f2008ts = 1348,                    /* -std=f2008ts */
  OPT_std_f2018 = 1349,                      /* -std=f2018 */
  OPT_std_f95 = 1350,                        /* -std=f95 */
  OPT_std_gnu = 1351,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1352, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1353, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1354,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1355,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1356,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1357, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1358, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1359,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1360,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1361,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1362,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1363, */                /* -std=gnu18 */
  ...
  /* OPT_std_iso9899_2017 = 1374, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1375, */         /* -std=iso9899:2018 */
