...
enum opt_code
{
  ...
  OPT_mbranch_likely = 1198,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1199,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1200,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1201,             /* -mcompact-branches= */
  OPT_mdebug = 1202,                         /* -mdebug */
  OPT_mdebugd = 1203,                        /* -mdebugd */
  OPT_mdivide_breaks = 1204,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1205,                  /* -mdivide-traps */
  OPT_mdmx = 1206,                           /* -mdmx */
  OPT_mdouble_float = 1207,                  /* -mdouble-float */
  OPT_mdsp = 1208,                           /* -mdsp */
  OPT_mdspr2 = 1209,                         /* -mdspr2 */
  OPT_meb = 1210,                            /* -meb */
  OPT_mel = 1211,                            /* -mel */
  OPT_membedded_data = 1212,                 /* -membedded-data */
  OPT_meva = 1213,                           /* -meva */
  OPT_mexplicit_relocs = 1214,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1215,                  /* -mextern-sdata */
  OPT_mfix_24k = 1216,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1217,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1218,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1219,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1220,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1221,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1222,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1223,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1224,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1225,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1226,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1227,                 /* -mfp-exceptions */
  OPT_mfp32 = 1228,                          /* -mfp32 */
  OPT_mfp64 = 1229,                          /* -mfp64 */
  OPT_mfpxx = 1230,                          /* -mfpxx */
  OPT_mframe_header_opt = 1231,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1232, */              /* -mfused-madd */
  OPT_mgp32 = 1233,                          /* -mgp32 */
  OPT_mgp64 = 1234,                          /* -mgp64 */
  OPT_mgpopt = 1235,                         /* -mgpopt */
  OPT_mhard_float = 1236,                    /* -mhard-float */
  OPT_mimadd = 1237,                         /* -mimadd */
  OPT_minterlink_compressed = 1238,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1239,              /* -minterlink-mips16 */
  OPT_mips = 1240,                           /* -mips */
  OPT_mips16 = 1241,                         /* -mips16 */
  OPT_mips3d = 1242,                         /* -mips3d */
  OPT_mllsc = 1243,                          /* -mllsc */
  OPT_mload_store_pairs = 1244,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1245,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1246,                    /* -mlong-calls */
  OPT_mlong32 = 1247,                        /* -mlong32 */
  OPT_mlong64 = 1248,                        /* -mlong64 */
  OPT_mlra = 1249,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1250,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1251,                           /* -mmad */
  OPT_mmadd4 = 1252,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1253,             /* -mmcount-ra-address */
  OPT_mmcu = 1254,                           /* -mmcu */
  OPT_mmemcpy = 1255,                        /* -mmemcpy */
  OPT_mmicromips = 1256,                     /* -mmicromips */
  OPT_mmsa = 1257,                           /* -mmsa */
  OPT_mmt = 1258,                            /* -mmt */
  OPT_mnan_ = 1259,                          /* -mnan= */
  OPT_mno_float = 1260,                      /* -mno-float */
  OPT_mno_flush_func = 1261,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1262,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1263,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1264,                     /* -mno-mips3d */
  OPT_modd_spreg = 1265,                     /* -modd-spreg */
  OPT_mpaired_single = 1266,                 /* -mpaired-single */
  OPT_mplt = 1267,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1268,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1269,               /* -mrelax-pic-calls */
  OPT_mshared = 1270,                        /* -mshared */
  OPT_msingle_float = 1271,                  /* -msingle-float */
  OPT_msmartmips = 1272,                     /* -msmartmips */
  OPT_msoft_float = 1273,                    /* -msoft-float */
  OPT_msplit_addresses = 1274,               /* -msplit-addresses */
  OPT_msym32 = 1275,                         /* -msym32 */
  OPT_msynci = 1276,                         /* -msynci */
  OPT_mtune_ = 1277,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1278,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1279,                          /* -mvirt */
  OPT_mvr4130_align = 1280,                  /* -mvr4130-align */
  OPT_mxgot = 1281,                          /* -mxgot */
  OPT_mxpa = 1282,                           /* -mxpa */
  OPT_n = 1283,                              /* -n */
  OPT_no_canonical_prefixes = 1284,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1285,              /* -no-integrated-cpp */
  OPT_no_pie = 1286,                         /* -no-pie */
  OPT_noasmopt = 1287,                       /* -noasmopt */
  OPT_nocpp = 1288,                          /* -nocpp */
  OPT_nodefaultlibs = 1289,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1290,                   /* -nostartfiles */
  OPT_nostdinc = 1291,                       /* -nostdinc */
  OPT_nostdinc__ = 1292,                     /* -nostdinc++ */
  OPT_nostdlib = 1293,                       /* -nostdlib */
  OPT_o = 1294,                              /* -o */
  OPT_p = 1295,                              /* -p */
  OPT_pass_exit_codes = 1296,                /* -pass-exit-codes */
  /* OPT_pedantic = 1297, */                 /* -pedantic */
  OPT_pedantic_errors = 1298,                /* -pedantic-errors */
  OPT_pg = 1299,                             /* -pg */
  OPT_pie = 1300,                            /* -pie */
  OPT_pipe = 1301,                           /* -pipe */
  ...
  OPT_s = 1316,                              /* -s */
  OPT_save_temps = 1317,                     /* -save-temps */
  OPT_save_temps_ = 1318,                    /* -save-temps= */
  OPT_shared = 1319,                         /* -shared */
  OPT_shared_libgcc = 1320,                  /* -shared-libgcc */
  /* OPT_specs = 1321, */                    /* -specs */
  OPT_specs_ = 1322,                         /* -specs= */
  OPT_static = 1323,                         /* -static */
  OPT_static_libasan = 1324,                 /* -static-libasan */
  OPT_static_libgcc = 1325,                  /* -static-libgcc */
  OPT_static_libgfortran = 1326,             /* -static-libgfortran */
  OPT_static_libgo = 1327,                   /* -static-libgo */
  OPT_static_liblsan = 1328,                 /* -static-liblsan */
  OPT_static_libmpx = 1329,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1330,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1331,               /* -static-libstdc++ */
  OPT_static_libtsan = 1332,                 /* -static-libtsan */
  OPT_static_libubsan = 1333,                /* -static-libubsan */
  OPT_static_pie = 1334,                     /* -static-pie */
  /* OPT_std_c__03 = 1335, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1336, */                /* -std=c++0x */
  OPT_std_c__11 = 1337,                      /* -std=c++11 */
  OPT_std_c__14 = 1338,                      /* -std=c++14 */
  OPT_std_c__17 = 1339,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1340, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1341, */                /* -std=c++1z */
  OPT_std_c__2a = 1342,                      /* -std=c++2a */
  OPT_std_c__98 = 1343,                      /* -std=c++98 */
  OPT_std_c11 = 1344,                        /* -std=c11 */
  OPT_std_c17 = 1345,                        /* -std=c17 */
  /* OPT_std_c18 = 1346, */                  /* -std=c18 */
  ...
  OPT_std_gnu__2a = 1365,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1366,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1367,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1368,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1369, */                /* -std=gnu18 */
  ...
  /* OPT_std_iso9899_2017 = 1380, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1381, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1382,                     /* -std=legacy */
  OPT_symbolic = 1383,                       /* -symbolic */
  OPT_t = 1384,                              /* -t */
  OPT_time = 1385,                           /* -time */
  OPT_time_ = 1386,                          /* -time= */
  OPT_traditional = 1387,                    /* -traditional */
  OPT_traditional_cpp = 1388,                /* -traditional-cpp */
  OPT_trigraphs = 1389,                      /* -trigraphs */
  OPT_u = 1390,                              /* -u */
  OPT_undef = 1391,                          /* -undef */
  OPT_v = 1392,                              /* -v */
  OPT_version = 1393,                        /* -version */
  OPT_w = 1394,                              /* -w */
  OPT_wrapper = 1395,                        /* -wrapper */
  OPT_x = 1396,                              /* -x */
  OPT_z = 1397,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
