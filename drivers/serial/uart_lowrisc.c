...
#ifdef CONFIG_UART_LOWRISC_PORT_0
...
static void uart_sifive_irq_cfg_func_0(void)
{
	IRQ_CONNECT(RISCV_MAX_GENERIC_IRQ + DT_INST_0_LOWRISC_UART0_IRQ_0,
		    CONFIG_UART_LOWRISC_PORT_0_IRQ_PRIORITY,
		    uart_sifive_irq_handler, DEVICE_GET(uart_sifive_0),
		    0);

	irq_enable(RISCV_MAX_GENERIC_IRQ + DT_INST_0_LOWRISC_UART0_IRQ_0);
}
#endif

#endif /* CONFIG_UART_LOWRISC_PORT_0 */

#ifdef CONFIG_UART_LOWRISC_PORT_1
...
static const struct uart_sifive_device_config uart_sifive_dev_cfg_1 = {
	.port         = DT_INST_1_LOWRISC_UART0_BASE_ADDRESS,
	.sys_clk_freq = DT_INST_1_LOWRISC_UART0_CLOCK_FREQUENCY,
	.baud_rate    = DT_INST_1_LOWRISC_UART0_CURRENT_SPEED,
	.rxcnt_irq    = CONFIG_UART_LOWRISC_PORT_1_RXCNT_IRQ,
	.txcnt_irq    = CONFIG_UART_LOWRISC_PORT_1_TXCNT_IRQ,
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
	.cfg_func     = uart_sifive_irq_cfg_func_1,
#endif
};

DEVICE_AND_API_INIT(uart_sifive_1, DT_INST_1_LOWRISC_UART0_LABEL,
		    uart_sifive_init,
...
static void uart_sifive_irq_cfg_func_1(void)
{
	IRQ_CONNECT(RISCV_MAX_GENERIC_IRQ + DT_INST_1_LOWRISC_UART0_IRQ_0,
		    CONFIG_UART_LOWRISC_PORT_1_IRQ_PRIORITY,
		    uart_sifive_irq_handler, DEVICE_GET(uart_sifive_1),
		    0);

	irq_enable(RISCV_MAX_GENERIC_IRQ + DT_INST_1_LOWRISC_UART0_IRQ_0);
}
#endif

#endif /* CONFIG_UART_LOWRISC_PORT_1 */
