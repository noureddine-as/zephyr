...
static const struct gpio_sifive_config gpio_sifive_config0 = {
	.gpio_base_addr    = DT_INST_0_LOWRISC_GPIO0_BASE_ADDRESS,
	.gpio_irq_base     = RISCV_MAX_GENERIC_IRQ + DT_INST_0_LOWRISC_GPIO0_IRQ_0,
	.gpio_cfg_func     = gpio_sifive_cfg_0,
};

static struct gpio_sifive_data gpio_sifive_data0;

DEVICE_AND_API_INIT(gpio_sifive_0, DT_INST_0_LOWRISC_GPIO0_LABEL,
		    gpio_sifive_init,
...
#define		IRQ_INIT(n)					\
IRQ_CONNECT(RISCV_MAX_GENERIC_IRQ + DT_INST_0_LOWRISC_GPIO0_IRQ_##n,	\
		CONFIG_GPIO_LOWRISC_##n##_PRIORITY,		\
...
static void gpio_sifive_cfg_0(void)
{
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_0
	IRQ_INIT(0);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_1
	IRQ_INIT(1);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_2
	IRQ_INIT(2);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_3
	IRQ_INIT(3);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_4
	IRQ_INIT(4);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_5
	IRQ_INIT(5);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_6
	IRQ_INIT(6);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_7
	IRQ_INIT(7);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_8
	IRQ_INIT(8);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_9
	IRQ_INIT(9);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_10
	IRQ_INIT(10);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_11
	IRQ_INIT(11);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_12
	IRQ_INIT(12);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_13
	IRQ_INIT(13);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_14
	IRQ_INIT(14);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_15
	IRQ_INIT(15);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_16
	IRQ_INIT(16);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_17
	IRQ_INIT(17);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_18
	IRQ_INIT(18);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_19
	IRQ_INIT(19);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_20
	IRQ_INIT(20);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_21
	IRQ_INIT(21);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_22
	IRQ_INIT(22);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_23
	IRQ_INIT(23);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_24
	IRQ_INIT(24);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_25
	IRQ_INIT(25);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_26
	IRQ_INIT(26);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_27
	IRQ_INIT(27);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_28
	IRQ_INIT(28);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_29
	IRQ_INIT(29);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_30
	IRQ_INIT(30);
#endif
#ifdef DT_INST_0_LOWRISC_GPIO0_IRQ_31
	IRQ_INIT(31);
#endif
}
